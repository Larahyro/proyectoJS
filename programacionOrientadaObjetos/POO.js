...
class encuestaTurismo {
    ...
    realizarEncuesta() {
      ...
      let opciones = prompt(" En tus últimas vacaciones, ¿utilizaste una agencia de turismo, recomendaciones de tu hotel, si viajaste por Chile (SERNATUR); o buscaste en internet y por tu cuenta recorriste el lugar?");
